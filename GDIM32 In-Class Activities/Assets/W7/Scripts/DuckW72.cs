...
public class DuckW72 : MonoBehaviour
{
    ...
    private Vector3 _raycastDir {
        get {
            return (PlayerW72.Instance.PlayerCenter - _raycastStart).normalized;
        }
    }
    ...
    private void RunPursueState ()
    {
        ...
        Vector3 playerPos = PlayerW72.Instance.transform.position;
    ...
    private void OnDrawGizmos ()
    {
        ...
        if(PlayerW72.Instance != null) Gizmos.DrawSphere(PlayerW72.Instance.PlayerCenter, 0.1f);
